...
function createGalleryItemTitle(id, title) {
    ...
    return $("<h3 class='category-title' id='title_" + id + "'>" + "<i class='fa " + menuItemIcon + "'></i>" + "&nbsp;&nbsp;" + title + "</h3><hr/>");
}
...
function resizeCharts() {
    ...
    charts.height(charts[0].offsetWidth * 0.56);
...
function scroll() {
    ...
    if (ele) {
         $("body").animate({scrollTop: ele.offset().top + 80 }, 0);
    }
}
